        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <NuxtLink class="nav-link" activeClass="active" to="/catagories">catagories</NuxtLink>
                    </li>
                </ul>
                <ul class="navbar-nav ms-auto">
                    <div class="d-flex" v-if="authUser">
                        <li class="nav-item">
                            <NuxtLink class="nav-link" activeClass="active" to="/dashboard">Dashboard</NuxtLink>
                        </li>
                        <li class="nav-item">
